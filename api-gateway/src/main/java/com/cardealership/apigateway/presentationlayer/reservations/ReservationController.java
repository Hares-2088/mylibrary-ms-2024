...
import com.cardealership.apigateway.businesslayer.reservations.ReservationService;
...
public class ReservationController {
    ...
    public ResponseEntity<Void> updateReservation(@RequestBody ReservationRequestModel reservationRequestModel, @PathVariable String reservationId,
                                                  @PathVariable String memberId) {
        reservationService.updateReservation(reservationRequestModel, reservationId, memberId);
